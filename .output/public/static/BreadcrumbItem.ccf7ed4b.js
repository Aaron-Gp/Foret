import{i as L}from"./baseurl.18409a28.js";import{f as g,ab as P,D as T,J as y,y as p,K as v,z as H,r as j,h as S,ao as $,A as E}from"./entry.d3d5afb2.js";import{c as w,d as m,a as s,e as A,f as u,g as x,h as I,w as O}from"./light.6fe86cbc.js";const V={fontWeightActive:"400"},K=e=>{const{fontSize:o,textColor3:r,textColor2:n,borderRadius:a,buttonColor2Hover:t,buttonColor2Pressed:c}=e;return Object.assign(Object.assign({},V),{fontSize:o,itemLineHeight:"1.25",itemTextColor:r,itemTextColorHover:n,itemTextColorPressed:n,itemTextColorActive:n,itemBorderRadius:a,itemColorHover:t,itemColorPressed:c,separatorColor:r})},D={name:"Breadcrumb",common:w,self:K},M=D,F=m("breadcrumb",`
 white-space: nowrap;
 cursor: default;
