      ...
      >
        <n-carousel-item :style="{ width: '60%' }">
          <n-card
            ...
            class="relative !opacity-60 bg-black text-white backdrop-blur-[2px]"
        ...
        <n-carousel-item :style="{ width: '60%' }">
          <n-card
            :style="{ width: '100%', height: '100%' }"
            class="relative backdrop-blur-[2px] !opacity-60 bg-black text-white"
            content-style="padding: 0;"
          >
            <template #header>
              <div class="text-white">
